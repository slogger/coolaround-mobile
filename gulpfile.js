...
gulp.task('copy', function () {
    ...
    var vulcanizedPages = gulp.src(['app/pages/pages.html'])
        .pipe($.rename('pages.vulcanized.html'))
        .pipe(gulp.dest('www/pages'));

    return merge(app, bower, elements, vulcanized, vulcanizedPages, swBootstrap, swToolbox)
...
gulp.task('clean-bower', del.bind(null, ['www/bower_components']));
